# THIS IS THE MAIN CODE FOR ALL THE ARE CODES 
# THIS CODE SORTS THE EVENTS ACCORDING TO IT TIMESTAMP WHICH IS 2400 NANO SEC
# THEN CREATE GRP AND LISTS THEN WITH UNIQUE CHANNELS 
# ALSO WE HAVE MENTIONS THE SET UP AND AS PER THAT CHANNELS ARE USED FURTHER
# ALSO DID THE RATIO AND TIME DIFFERENCE OF ALL THE AVAILABLE CHANNELS 
# ITS THE HEART ABD CORE CODE OF THIS ENTIRE FILES BECAUSE THEY ARE CONNECTED TO THIS FILE
