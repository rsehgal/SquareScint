...
int main(int argc, char *argv[])
{
  ...
  for (Long64_t i = 0; i < nentries; i++) {
    ...
    if (q4 > 0 && q5 > 0 && q6 > 0 && q7 > 0) {
      xdelT       = log((1. * q6) / (1. * q7));
      ydelT       = log((1. * q4) / (1. * q5));
      //double posX = -1.84769 + 22.2308 * xdelT - 0.419317 * ydelT;
      //double posY = 0.676532 - 0.347919 * xdelT - 21.6335 * ydelT;

      double posX = 0.1428 + 22.1564 * xdelT - 0.31254 * ydelT-0.8412*xdelT*ydelT;
      double posY = 0.0831 + 0.2874 * xdelT + 21.98424 * ydelT-0.7956*xdelT*ydelT;
