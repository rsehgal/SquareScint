...
void biasSigma(char *filename)
{
  ...
  TH1F *hist01 = new TH1F("hist01", "hist01", 200, -10, 10);
  TH1F *hist02 = new TH1F("hist02", "hist02", 200, -10, 10);
  TH1F *hist03 = new TH1F("hist03", "hist03", 200, -10, 10);
  TH1F *hist12 = new TH1F("hist12", "hist12", 200, -10, 10);
  TH1F *hist13 = new TH1F("hist13", "hist13", 200, -10, 10);
  TH1F *hist23 = new TH1F("hist23", "hist23", 200, -10, 10);
...
std::cout <<"======== Mean Vec ============" << std::endl;
  for(const auto& val : meanVec){
	std::cout << val <<",";
  }
std::cout << std::endl;
std::cout <<"======== Sigma Vec ============" << std::endl;
