...
int main(int argc, char *argv[])
{
  ...
  std::string outputFile = std::string(argv[2]);// "Muon_"+std::string(argv[2])+"_"+std::string(argv[3])+".root";
  std::cout <<"OutFile : " << outputFile << std::endl;
  double posx = std::atoi(argv[3]);
  double posy = std::atoi(argv[4]);
  TFile *of     = new TFile(argv[2], "RECREATE");
